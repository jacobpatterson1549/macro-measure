...
export const createHandlers = (objectStoreName, setItemID, setView, viewType) => ({
    ...
    createEnd: (item) => actionHandler(setView, viewType, View.isRead, createItem, objectStoreName, item),
...
const actionHandler = (setView, viewType, viewAction, action, ...params) => {
